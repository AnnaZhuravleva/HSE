...
for off in offsets:
    req = urllib.request.Request('https://api.vk.com/method/wall.get?'
                                 'owner_id=&domain=dfzwe4&v=5.74&access_token='
                                 '364952c2364952c2364952c23b362bf79f33649364952'
                                 'c26caca3158b4898baf5a9e2ba&count=100&offset=' + str(off))
...
l = cursor.fetchall()
for i in l: 
    req = urllib.request.Request('https://api.vk.com/method/wall.getComments?owner_id=-40232010&post_id='
                                 +i[0]+'&v=5.74&access_token=364952c2364952c2364952c23b362bf79f3364936495'
                                       '2c26caca3158b4898baf5a9e2ba&count=100')
    response = urllib.request.urlopen(req) 
    result = response.read().decode('utf-8')
    data = json.loads(result)
    print(data['response']) 
    ...
    if number >> 100:
        ...
        for off in offsets:
            req = urllib.request.Request('https://api.vk.com/method/wall.getComments?owner_id=-40232010&post_id='
                                         +i[0]+'&v=5.74&access_token=364952c2364952c2364952c23b362bf79f3364936495'
                                               '2c26caca3158b4898baf5a9e2ba&count=100&offset='+str(off))
            response = urllib.request.urlopen(req) 
            result = response.read().decode('utf-8')
            data = json.loads(result)
            print(data['response'])
